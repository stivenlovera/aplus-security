...
var UniteAdminRev = new function(){
	...
	********************************/
	...
	t.ajaxRequest = function(action,data,successFunction,hideOverlay){
		...
		var objData = {
			task:action,
			// nonce:g_revNonce, remove in joomla version
			data:data
		}
		...
		jQuery.ajax({
			type:"post",
			url:'index.php?option=com_zt_layerslider',
			dataType: 'json',
			data:objData,
	...
	var updateVideoSizeProps = function(){
		...
		ZtSliderSettings.onoffStatus(jQuery('#input_video_fullwidth'));
		ZtSliderSettings.onoffStatus(jQuery('#input_video_cover'));
	}
	...
	t.openVideoDialog = function(callback,objCurrentVideoData,gal_type){
		...
		//ZtSliderSettings.onoffStatus(jQuery("#input_video_autoplay"));
		//ZtSliderSettings.onoffStatus(jQuery("#input_video_autoplay_first_time"));
		ZtSliderSettings.onoffStatus(jQuery("#input_video_nextslide"));
		ZtSliderSettings.onoffStatus(jQuery("#input_video_force_rewind"));
		ZtSliderSettings.onoffStatus(jQuery("#input_video_fullwidth"));
		ZtSliderSettings.onoffStatus(jQuery("#input_video_control"));
		ZtSliderSettings.onoffStatus(jQuery("#input_video_mute"));
		ZtSliderSettings.onoffStatus(jQuery("#input_disable_on_mobile"));
		ZtSliderSettings.onoffStatus(jQuery("#input_video_cover"));
		ZtSliderSettings.onoffStatus(jQuery("#input_video_stopallvideo"));
		ZtSliderSettings.onoffStatus(jQuery("#input_video_allowfullscreen"));
		ZtSliderSettings.onoffStatus(jQuery("#input_use_poster_on_mobile"));
		ZtSliderSettings.onoffStatus(jQuery("#input_video_show_cover_pause"));
		ZtSliderSettings.onoffStatus(jQuery("#input_video_large_controls"));
		ZtSliderSettings.onoffStatus(jQuery("#input_video_leave_fs_on_pause"));
		ZtSliderSettings.onoffStatus(jQuery("#input_video_show_visibility"));
	...
	var initGeneralSettings = function(){
		...
		jQuery("#button_save_general_settings").click(function(){
			var data = ZtSliderSettings.getSettingsObject("form_general_settings");
