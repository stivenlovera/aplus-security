...
jQuery(document).ready(function(){
	UniteLayersRev.setGlobalAction(UniteLayersRev.wptemplate( "rs-action-layer-wrap" ));
	UniteLayersRev.setGlobalSlideImport(UniteLayersRev.wptemplate( "rs-import-layer-wrap" ));
});
...
var UniteLayersRev = new function(){
			...
			if(set_anim == 'out' && anim_handle == 'auto'){ //check if masking is enabled for in-animation, if yes do it here, too
				if(jQuery('#masking-start')[0].checked){
					if(jQuery('#masking-start')[0].checked == true){
						...
						ZtSliderSettings.onoffStatus(jQuery('#masking-end'));	
		...
		switch(bbggtt){
			case "image":
				...
				switch(gallery_type){
					...
					break;
					case 'posts':
						bgimg = rs_plugin_url+'assets/images/sources/post.png';
					break;
					case 'facebook':
						bgimg = rs_plugin_url+'assets/images/sources/fb.png';
					break;
					case 'twitter':
						bgimg = rs_plugin_url+'assets/images/sources/tw.png';
					break;
					case 'instagram':
						bgimg = rs_plugin_url+'assets/images/sources/ig.png';
					break;
					case 'flickr':
						bgimg = rs_plugin_url+'assets/images/sources/fr.png';
					break;
					case 'youtube':
						bgimg = rs_plugin_url+'assets/images/sources/yt.png';
					break;
					case 'vimeo':
						bgimg = rs_plugin_url+'assets/images/sources/vm.png';
					break;
				}
	...
	*****************************************************/
		...
		jQuery('#rs-import-layer-slider').change(function(){
			...
			if(im_slider_id == '-'){
				...
				if(typeof(import_slides[im_slider_id]) == 'undefined'){ //get data for the im_slider_id
					UniteAdminRev.ajaxRequest('slider.getimportslidesdata', im_slider_id, function(response){
	...
	var setNewAnimFromObj = function(what, obj_v){
		...
		ZtSliderSettings.onoffStatus(jQuery('#masking-start'));
		ZtSliderSettings.onoffStatus(jQuery('#masking-end'));
	...
	t.updateReverseList = function() {
		...
		updateRevTimer =  setTimeout(function() {
			ZtSliderSettings.onoffStatus(jQuery('#layer_anim_xstart_reverse'));
			ZtSliderSettings.onoffStatus(jQuery('#layer_anim_ystart_reverse'));
			ZtSliderSettings.onoffStatus(jQuery('#layer_anim_xrotate_reverse'));
			ZtSliderSettings.onoffStatus(jQuery('#layer_anim_yrotate_reverse'));
			ZtSliderSettings.onoffStatus(jQuery('#layer_anim_zrotate_reverse'));
			ZtSliderSettings.onoffStatus(jQuery('#layer_scale_xstart_reverse'));
			ZtSliderSettings.onoffStatus(jQuery('#layer_scale_ystart_reverse'));
			ZtSliderSettings.onoffStatus(jQuery('#layer_skew_xstart_reverse'));
			ZtSliderSettings.onoffStatus(jQuery('#layer_skew_ystart_reverse'));
			ZtSliderSettings.onoffStatus(jQuery('#mask_anim_xstart_reverse'));
			ZtSliderSettings.onoffStatus(jQuery('#mask_anim_ystart_reverse'));

			ZtSliderSettings.onoffStatus(jQuery('#layer_anim_xend_reverse'));
			ZtSliderSettings.onoffStatus(jQuery('#layer_anim_yend_reverse'));
			ZtSliderSettings.onoffStatus(jQuery('#layer_anim_xrotate_end_reverse'));
			ZtSliderSettings.onoffStatus(jQuery('#layer_anim_yrotate_end_reverse'));
			ZtSliderSettings.onoffStatus(jQuery('#layer_anim_zrotate_end_reverse'));
			ZtSliderSettings.onoffStatus(jQuery('#layer_scale_xend_reverse'));
			ZtSliderSettings.onoffStatus(jQuery('#layer_scale_yend_reverse'));
			ZtSliderSettings.onoffStatus(jQuery('#layer_skew_xend_reverse'));
			ZtSliderSettings.onoffStatus(jQuery('#layer_skew_yend_reverse'));
			ZtSliderSettings.onoffStatus(jQuery('#mask_anim_xend_reverse'));
			ZtSliderSettings.onoffStatus(jQuery('#mask_anim_yend_reverse'));
		},100);
	}
	 ...
	 * add image layer
	 */
	t.addLayerImage = function(imgobj, special_type){
	...
	*/
	...
	var updateSubStyleParameters = function(objLayer, reset_full) {
		...
		ZtSliderSettings.onoffStatus(jQuery('#hover_allow'));
		ZtSliderSettings.onoffStatus(jQuery('#toggle_allow'));
		ZtSliderSettings.onoffStatus(jQuery('#toggle_use_hover'));
		...
		if(objLayer.deformation != undefined){
			...
			ZtSliderSettings.onoffStatus(jQuery('#css_font-style'));
			...
			ZtSliderSettings.onoffStatus(jQuery('#css_layer_selectable'));*/
	...
	var updateLayerFormFields = function(serial){
		...
		ZtSliderSettings.onoffStatus(jQuery('#toggle_allow'));
		ZtSliderSettings.onoffStatus(jQuery('#toggle_use_hover'));
		ZtSliderSettings.onoffStatus(jQuery('#visible-desktop'));
		ZtSliderSettings.onoffStatus(jQuery('#visible-notebook'));
		ZtSliderSettings.onoffStatus(jQuery('#visible-tablet'));
		ZtSliderSettings.onoffStatus(jQuery('#visible-mobile'));
		ZtSliderSettings.onoffStatus(jQuery('#layer_on_slider_hover'));
		...
		ZtSliderSettings.onoffStatus(jQuery('.rs-proportion-check'));
		ZtSliderSettings.onoffStatus(jQuery('.rs-linebreak-check'));
		...
		ZtSliderSettings.onoffStatus(jQuery("#layer_hidden"));
		ZtSliderSettings.onoffStatus(jQuery("#layer_resizeme"));
		ZtSliderSettings.onoffStatus(jQuery("#layer_resize-full"));
		ZtSliderSettings.onoffStatus(jQuery("#layer_resp_offset"));
		ZtSliderSettings.onoffStatus(jQuery("#layer-seo-optimized"));
