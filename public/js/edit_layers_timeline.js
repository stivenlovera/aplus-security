...
!function t(e, n, r) {
    ...
    12: [function (t, e, n) {
        ...
        var o = t("../../lib/helper"), i = t("../../lib/dom"), l = t("../instances"), s = t("../update-geometry"), a = t("../update-scroll");
        e.exports = function (t) {
            var e = l.get(t);
            r(t, e)
        }
    ...
    18: [function (t, e, n) {
        ...
        var s = t("../lib/class"), a = t("../lib/dom"), c = t("./default-setting"), u = t("../lib/event-manager"), d = t("../lib/guid"), p = t("../lib/helper"), f = {};
        n.add = function (t) {
            var e = d();
...
var tpLayerTimelinesRev = new function () {
    ...
    t.init = function () {
        ...
        jQuery('.input-deepselects').each(function () {
            ...
            dl.append(txt);
            if (rev == "on") {
                ZtSliderSettings.onoffStatus(jQuery('input[name="' + id + '_reverse"]'));
            }
        })
    ...
    t.rebuildLayerIdle = function (caption, timer, isDemo) {
        ...
        if (e_img.length > 0 && !jQuery(e_img).hasClass("loaded")) {
            ...
            img.onerror = function () {
                e_img[0].src = objLayer.image_url = g_revslider_url + "/assets/images/tp-brokenimage.png";
                u.updateHtmlLayerPosition(false, caption, objLayer, u.getVal(objLayer, 'top'), u.getVal(objLayer, 'left'), u.getVal(objLayer, 'align_hor'), u.getVal(objLayer, 'align_vert'));
            }
    ...
    t.drawAudioMap = function (objLayer) {
        ...
        try {
            ...
            console.log("Drwaring of Audio Map Failer at Initialisation");
        }
            ...
            li.on('mousemove', function (e) {
                ...
                li.data('audiopreview', setTimeout(function () {
                    ...
                    if (time > 0) {
                        ...
                        punchgs.TweenLite.fromTo(ap, (player.duration - time / 100), {
                            left: (dl + time + (shift * (player.duration * 100))),
                            transformOrigin: "0% 50%",
                            width: restw,
                            scaleX: 0
                        }, {scale: 1, ease: punchgs.Linear.easeNone});
                    }
                    if (time > 0) {
                        player.play();
